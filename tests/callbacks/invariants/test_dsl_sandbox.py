"""Adversarial tests for ``lighttrain.callbacks.invariants._dsl.evaluate_check``.
...
from lighttrain.callbacks.invariants._dsl import InvariantError, evaluate_check

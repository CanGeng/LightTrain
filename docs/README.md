...
| Topic | What's inside |
| ----- | ------------- |
| [Distributed training](operations/distributed.md) | The `parallel:` block: DDP / FSDP / ZeRO / TP / PP / SP / EP |
...
| 主题 | 内容 |
| ---- | ---- |
| [分布式训练](operations/distributed.zh-CN.md) | `parallel:` 块：DDP / FSDP / ZeRO / TP / PP / SP / EP |
